...
#         torch.backends.cudnn.deterministic = True
    ...
    # )
    parser.add_argument('--log', '-l',type=str,default='logs/log_train_%s' % datetime.datetime.now().strftime('%Y%m%d-%H%M%S'),help='Directory to put the log data. Default: ~/logs/date+time',
    )
    parser.add_argument(
        '--name', '-n',
        type=str,
